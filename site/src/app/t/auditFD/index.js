...
import FdActions from '../../../component/ContentT/FdActions';
...
export default class Home extends Component {
	...
	@computed
	get topicList() {
		return toJS(this.props.teacherStore.auditFD_topicList);
	}
	...
	componentWillMount() {
		...
		this.props.teacherStore.AuditFd_getAuditPermission({"userId": this.usr.uid});
	}
	...
	render() {
		const columns = [
			...
			},
			{
				title: '操作',
				render: (text, record) => (
					<FdActions record={record}></FdActions>
				),
			}
		];

		return (
			<div className="g-content" data-component="t-auditFD">
				<div class="m-main">
