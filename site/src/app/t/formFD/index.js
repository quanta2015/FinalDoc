...
export default class Home extends Component {
    ...
    handleFormSubmit(form){
        ...
        if(flag)
            ...
            if(this.isTutor)
                this.props.teacherStore.AuditFd_submitTutorForm({"comment":comment,
                                                                "score":score,
                                                                "pass":pass})
                .then(()=>{route("/t_manage")});
            else
                this.props.teacherStore.AuditFd_submitTeamForm({"comment":comment,
                                                                "score":score,
                                                                "pass":pass})
